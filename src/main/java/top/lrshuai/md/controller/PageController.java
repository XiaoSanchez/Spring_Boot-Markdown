...
public class PageController {
	...
	public String detail(Model model, HttpSession session) {
		...
		if (code != null) {
			...
			model.addAttribute(MD_CODE, "Input here...");
		}
		return "detail";
	}
	...
	@ResponseBody
	public ResponseEntity<?> getImg(@PathVariable("folderName") String folderName,
			@PathVariable("filename") String filename) {
		try {
			return ResponseEntity.ok(
					resourceLoader.getResource("file:" + Paths.get(root_fold + "/" + folderName, filename).toString()));
		} catch (Exception e) {
